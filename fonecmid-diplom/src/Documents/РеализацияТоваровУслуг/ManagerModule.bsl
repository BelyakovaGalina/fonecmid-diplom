...
// ++БелГН ВКМ 22.10.2025
	...
	Если ПечатнаяФорма <> Неопределено Тогда
	    ПечатнаяФорма.ТабличныйДокумент = ПечатьАктаУслуг(МассивОбъектов, ОбъектыПечати);
	    ПечатнаяФорма.СинонимМакета = НСтр("ru = 'Акт об аказанных услугах'");
	    ПечатнаяФорма.ПолныйПутьКМакету = "Документ.РеализацияТоваровУслуг.ПФ_XML_ВКМ_АктОбАказанныхУслугах";
	КонецЕсли;
// --
КонецПроцедуры
...
Функция ПечатьАктаУслуг(МассивОбъектов, ОбъектыПечати)
// ++БелГН ВКМ 22.10.2025
	ТабличныйДокумент = Новый ТабличныйДокумент;
	ТабличныйДокумент.КлючПараметровПечати = "ПараметрыПечати_АктУслуг";
	
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.РеализацияТоваровУслуг.ПФ_XML_ВКМ_АктОбАказанныхУслугах");
	...
	Пока ДанныеДокументов.Следующий() Цикл
		...
		ВКМ_ВывестиЗаголовокАктаУслуг(ДанныеДокументов, ТабличныйДокумент, Макет);
		...
		ВКМ_ВывестиПодвалАктаУслуг(ДанныеДокументов, ТабличныйДокумент, Макет);
...
Процедура ВКМ_ВывестиЗаголовокАктаУслуг(ДанныеДокументов, ТабличныйДокумент, Макет)
// ++БелГН ВКМ 22.10.2025
...
// ++БелГН ВКМ 22.10.2025
	...
	ТекстИтоговойСтроки = СтрШаблон(ШаблонИтоговойСтроки, КоличествоУслуг, Формат(ДанныеДокументов.СуммаДокумента, "ЧДЦ=2;"));
	ДанныеПечати.Вставить("ИтоговаяСтрока", ТекстИтоговойСтроки);
...
Процедура ВКМ_ВывестиПодвалАктаУслуг(ДанныеДокументов, ТабличныйДокумент, Макет)
// ++БелГН ВКМ 22.10.2025
